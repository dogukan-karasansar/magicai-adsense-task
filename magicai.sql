...
-- Üretim Zamanı: 01 Tem 2023, 01:13:43
...
CREATE TABLE `settings` (
  ...
  `gcs_file` varchar(255) DEFAULT NULL,
  `gcs_name` varchar(255) DEFAULT NULL,
  ...
  `free_plan` varchar(255) NOT NULL DEFAULT '0,0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
